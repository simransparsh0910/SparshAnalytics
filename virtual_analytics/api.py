...
class APIHandler:
    ...
    def _configure_logging(self):
        ...
        if not logger.handlers:
            fh = logging.FileHandler('/app/virtual_analytics/LOGS/api_handler.log')
    ...
    def _modify_payload(self, payload):
        ...
        modified_payload = {
            ...
            "AlertSubtype": payload.get("event_type", "Intrusion_Detected").upper(),
            "Sensor": payload.get("device_id", "Unknown_Camera"),
            "Remarks": payload.get("remarks", "Intrusion detected"),
            ...
            "AlertExternalValue": payload.get("external_value", f"INTRUSION_{payload.get('device_id', 'Unknown')}"),
